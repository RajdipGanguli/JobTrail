  ...
  return (
    <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-slate-50">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 className="text-2xl font-bold tracking-tight text-slate-900">Track your career journey</h2>
        <p className="mt-1 text-sm text-slate-500">Create your workspace in seconds</p>
      </div>
